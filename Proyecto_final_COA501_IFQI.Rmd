...
variables como transparencia de copa, severidad, incidencia, longitud de brotes, área de áciculas, etc. El objetivo del análisis es determinar la mejor técnica de machine learning o aprendizaje automático (Naive Bayes, K-NN y Random Forest) para clasificar la transparencia de copa en Douglas-fir.

```{r echo=FALSE, out.width='60%', out.height="40%",fig.show='hold',fig.align ='center'}
knitr::include_graphics('./tc.jpg')
```
